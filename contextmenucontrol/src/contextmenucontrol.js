 ...
 * @param opt_opts.dirsFrom {false} Does not show 'Directions from here'
 * @param opt_opts.dirsTo {false} Does not show 'Directions to here'
 * @param opt_opts.zoomIn {false} Does not show 'Zoom In'
 * @param opt_opts.zoomOut {false} Does not show 'Zoom Out'
 * @param opt_opts.centerMap {false} Does not show 'Center Map here'
 * @param opt_opts.whatsHere {false} Does not show 'What's here?'
 * @constructor
 */
...
/**
 * @desc Is called by GMap2's addOverlay method.
...
/*
 * @desc Creates a draggable marker for searching directions.
...
/*
 * @desc Creates an initially hidden unordered menu list.
...
/* @desc Avoids firing a mouseout event when the mouse moves over a child element.
...
/* @desc Checks if the mouse leaves the parent element.
...
/*
 * @desc Creates clickable context menu list items.
...
/*
 * @desc Removes direction markers on contextual click.
...
/*
 * @desc Adds previously removed and further destinations.
 * @private
*/
...
/*
 * @desc Creates a styled horizontal ruler between the list entries.
...
/*
 * @desc Hides the context menu and sets its property visible to false.
 * @private
 */
...
/*
 * @desc Removes the context menu from the map container and adds a changed one.
...
/*
 * @desc Checks the finally touched marker to request the appropriate route.
...
/*
 * @desc Creates alphabetically arranged capital letters for direction markers.
...
/*
 * @desc Creates an icon object with properties.
...
/*
 * @desc Creates and adds direction markers.
...
/*
 * @desc Error alerts for failed direction queries.
 * @private
 */
...
/*
 * @desc Callback function for direction queries.
 * @private
 */
...
/*
 * @desc Creates info windows for direction steps.
...
ContextMenuControl.prototype.createRouteInfo = function (info, nr, i) {
  ...
  zlink.setAttribute("href", "javascript:void(0)");     //<------------ You have to any method.
  zlink.innerHTML = "Zoom In";
  zlink.style.marginRight = "20px";

  var blink = document.createElement("a");
  blink.setAttribute("href", "javascript:void(0)");    //<------------ You have to any method.
  ...
  flink.setAttribute("href", "javascript:void(0)");    //<------------ You have to any method.
...
/*
 * @desc Handles direction queries. Either first or second param must be passed in.
...
/*
 * @descCreates the form for searching directions displayed in infowindow.
...
ContextMenuControl.prototype.makeForm_ = function (letter) {
  ...
  rlink.setAttribute("href", "javascript:void(0)");    //<------------ You have to any method.
  ...
  setTimeout(function () {
    ...
    if (inputfield.nodeName.toUpperCase() === "INPUT") {
      inputfield.focus();
    }
  }, 1000);
...
/*
 * @desc Removes markers and polylines from the map and resets globals.
...
ContextMenuControl.prototype.removeOld_ = function (what) {
 ...
 /*
 * @desc Tries to reverse geocode the clicked point and
